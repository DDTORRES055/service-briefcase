...
app.use("/api/applications", verifyAuthToken, require("./routes/applications.routes"));
app.use("/api/dbms", verifyAuthToken, require("./routes/dbms.routes"));
app.use("/api/departments", verifyAuthToken, require("./routes/departments.routes"));
app.use("/api/hardware", verifyAuthToken, require("./routes/hardware.routes"));
app.use("/api/networkComponents", verifyAuthToken, require("./routes/networkComponents.routes"));
